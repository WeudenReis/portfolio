...
const experiences: Experience[] = [
  {
    ...
    period: "2024 - Atual",
    type: "SaaS & Integrações",
    achievements: [
      "Atendimento e suporte a clientes, resolvendo problemas na plataforma SaaS ChatPro.",
      "Execução de onboarding técnico garantindo configuração correta do ambiente SaaS.",
      "Suporte a integrações via API com base em documentação técnica.",
      "Monitoramento e ajustes básicos em clusters Kubernetes.",
      "Gestão de clientes e instâncias via CRM; diagnóstico e reporte ao time de desenvolvimento.",
    ],
  },
  {
    id: "kybronze",
    company: "Ky Bronze Indústria",
    position: "Auxiliar de Escritório",
    period: "Ago 2024 - 2025",
    type: "Administrativo & RH",
    achievements: [
      "Responsável por folha de pagamento, admissões e controle de ponto.",
      "Suporte administrativo à direção e organização de documentos.",
      "Atendimento a funcionários e resolução de demandas internas.",
    ],
  },
  {
    id: "autonomo",
    company: "Assistência Técnica",
    position: "Técnico Autônomo",
    period: "2022 - 2024",
    type: "Hardware & Suporte",
    achievements: [
      "Formatação, manutenção preventiva e corretiva de computadores.",
      "Instalação e configuração de softwares; suporte e reparos em impressoras.",
    ],
  },
];
